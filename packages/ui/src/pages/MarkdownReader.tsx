...
export const PAGE_ID = "files";

export function createMarkdownReaderPage(fsService: FileSystemService): PageDefinition {
  return {
    id: PAGE_ID,
    label: "文件",
    icon: "📄",
    render: () => <MarkdownReaderPage fsService={fsService} />,
  };
}
